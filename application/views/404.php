		...
		<div class="page-header">
			<div class="row">
				...
				<div class="col-md-6 col-lg-6 text-right">
					...
					<h5 class="padding-right-5"><a href="../traders/logout">[Logout]</a></h5> -->
			...
			<div class="row">
				<div class="col-md-12 col-lg-12">
					...
					<div class="signup_box width-50">
							...
							<p class="text-center"><a href="<?php echo 	site_url()?>/console/login">Go Back</a></p>
						</div>
...
<!-- 						<div class="signup_box">
					...
					<div class="col-md-6 col-lg-6">
						<!-- <div class="signup_box">
							...
							<div>
								<form action="/trader/index.php/traders/login" method="post">
									<div class="form-control">
										<label for="Name">Email  </label>
